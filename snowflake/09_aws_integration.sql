...
CREATE OR REPLACE EXTERNAL ACCESS INTEGRATION aws_thailand_healthcare_patient_journey_BEDROCK_EAI
  ALLOWED_NETWORK_RULES = (PATIENT_JOURNEY.APP.BEDROCK_NETWORK_RULE)
  ALLOWED_AUTHENTICATION_SECRETS = (PATIENT_JOURNEY.APP.AWS_BEDROCK_SECRET)
  ENABLED = TRUE
  COMMENT = 'Bedrock access for International Patient Journey Analytics';
...
CREATE OR REPLACE FUNCTION APP.BEDROCK_GENERATE(prompt VARCHAR)
  ...
  EXTERNAL_ACCESS_INTEGRATIONS = (aws_thailand_healthcare_patient_journey_BEDROCK_EAI)
  SECRETS = ('aws_creds' = PATIENT_JOURNEY.APP.AWS_BEDROCK_SECRET)
AS $$
...
CREATE OR REPLACE EXTERNAL ACCESS INTEGRATION aws_thailand_healthcare_patient_journey_SNS_EAI
  ALLOWED_NETWORK_RULES = (PATIENT_JOURNEY.APP.SNS_NETWORK_RULE)
  ALLOWED_AUTHENTICATION_SECRETS = (PATIENT_JOURNEY.APP.AWS_BEDROCK_SECRET)
  ENABLED = TRUE
